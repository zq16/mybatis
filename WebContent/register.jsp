...
<meta charset="UTF-8">
  ...
  <% 
		...
		if("usernameError".equals(errorMsg)){
	%>
	<script type="text/javascript">
		window.alert("用户名已存在，请重新输入");
	</script>		
	<% }else if("imageError".equals(errorMsg)){%>
	<script type="text/javascript">
		window.alert("验证码有误");
	</script>
	<%}	%>
  ...
  <body>
   <form  method="post" action="UsersServlet" name="form1">
		...
		<div class="regist">
			<div class="regist_center">
				...
				<div class="regist_main center">
					<div class="username">用&nbsp;&nbsp;户&nbsp;&nbsp;名:&nbsp;&nbsp;<input class="shurukuang" type="text" name="username" placeholder="请输入你的用户名" value="${users.username }"/><span>用户名长度在6-16位</span></div>
					...
					<div class="username">手&nbsp;&nbsp;机&nbsp;&nbsp;号:&nbsp;&nbsp;<input class="shurukuang" type="text" name="phonenumber" placeholder="请填写正确的手机号" value="${users.phonenumber }"/><span>填写下手机号吧，方便我们联系您！</span></div>
					<div class="username">收货地址:&nbsp;&nbsp;<input class="shurukuang" type="text" name="address" placeholder="请输入您的收货地址" value="${users.address }"/><span>收货地址一定要填正确哦</span></div>
					<div class="username">兴趣爱好:&nbsp;&nbsp;<input class="shurukuang" type="text" name="hobby" placeholder="请添加您的兴趣爱好" value="${users.hobby }"/><span>可以写一些您的爱好</span></div>
					<div class="username">个性标签:&nbsp;&nbsp;<input class="shurukuang" type="text" name="sign" placeholder="请添加您的个性标签" value="${users.sign }"/><span>添加您的个性标签</span></div>
				    <div class="username">
