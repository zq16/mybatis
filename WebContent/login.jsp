...
<html>
  ...
  <body>
    <!-- login -->
		...
		<form  method="post" action="UsersServlet" class="form center" name="form">
		...
		<div class="login">
			<div class="login_center">
				...
				<div class="login_main center">
					<div class="username">用户名:&nbsp;<input class="shurukuang" type="text" name="username" placeholder="请输入你的用户名" value="${users.username }"/><br/><span id="error_msg"></span></div>
					<div class="username">密&nbsp;&nbsp;&nbsp;&nbsp;码:&nbsp;<input class="shurukuang" type="password" name="password" placeholder="请输入你的密码" value="${users.password }" /><br/><span id="error_msg"></span></div>
                    <div class="username">
						<div class="left fl">
