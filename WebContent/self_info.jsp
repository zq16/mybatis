...
<div class="rtcont fr">
	<div class="grzlbt ml40">我的资料</div>
	<div class="subgrzl ml40"><span><a href="UsersServlet?operate=edit&uid=${loggedUser.uid}">编辑资料</a></span></div>
<div class="subgrzl ml40"><span>昵称</span><span>${loggedUser.username }</span></div>
<div class="subgrzl ml40"><span>手机号</span><span>${loggedUser.phonenumber }</span></div>
<div class="subgrzl ml40"><span>密码</span><span>******</span></div>
<div class="subgrzl ml40"><span>个性签名</span><span>${loggedUser.sign }</span></div>
<div class="subgrzl ml40"><span>我的爱好</span><span>${loggedUser.hobby }</span></div>
<div class="subgrzl ml40"><span>收货地址</span><span>${loggedUser.address }</span></div>
